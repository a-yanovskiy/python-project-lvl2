...
PATH_TO_JSON_RESULT_1_2_FILES = 'tests/fixtures/json_result_1-2_files.txt'
...
def test_get_diff_json_1_2_files():
    ...
    f = open(PATH_TO_JSON_RESULT_1_2_FILES)
...
PATH_TO_JSON_RESULT_3_4_FILES = 'tests/fixtures/json_result_3-4_files.txt'
...
def test_get_diff_json_3_4_files():
    ...
    f = open(PATH_TO_JSON_RESULT_3_4_FILES)
